...
export const BASKETBALL_VIEWS: Record<string, BasketballViews> = {
  BASIC: 'basketball-basic-stats',
  MEDIUM: 'basketball-medium-stats',
  MEDIUM_PLUS_SCORESHEET_AND_STATS: 'basketball-medium-stats-plus-scoresheet',
  MEDIUM_PLUS_SCORESHEET:
    'basketball-medium-stats-plus-scoresheet-scoresheet-only',
  MEDIUM_PLUS_STATS: 'basketball-medium-stats-plus-scoresheet-stats-only',
  SCORESHEET: 'basketball-scoresheet',
} as const;
...
export const PLAYER_STATS: PlayerStat[] = [
  {
    ...
    view: [
      ...
      BASKETBALL_VIEWS.SCORESHEET,
      BASKETBALL_VIEWS.MEDIUM_PLUS_STATS,
    ],
