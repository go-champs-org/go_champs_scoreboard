defmodule GoChampsScoreboard.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      {DynamicSupervisor,
       name: GoChampsScoreboard.Infrastructure.GameCaptureTemporalStatsSupervisor,
      ...
      {Registry,
       keys: :unique, name: GoChampsScoreboard.Infrastructure.GameCaptureTemporalStatsRegistry},
      {Registry,
