defmodule GoChampsScoreboard.Events.Definitions.RemoveCoachInTeamDefinition do
  ...
  def handle(game_state, %Event{payload: %{"team-type" => team_type, "coach-id" => coach_id}}) do
    game_state
    |> Teams.remove_coach(team_type, coach_id)
  end
