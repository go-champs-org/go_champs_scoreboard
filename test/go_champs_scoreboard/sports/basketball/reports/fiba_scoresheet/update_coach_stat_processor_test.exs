defmodule GoChampsScoreboard.Sports.Basketball.Reports.FibaScoresheet.UpdateCoachStatProcessorTest do
  ...
  describe "process/2" do
    test "returns a fiba scoresheet data coach fouls when event log payload with fouls_personal operation is increment and team-type is away" do
    ...
    test "returns a fiba scoresheet data coach fouls with extra_action when event log payload with fouls_personal operation is increment, team-type is home, and metadata has free-throws-awarded" do
      game_state = basketball_game_state_fixture()
